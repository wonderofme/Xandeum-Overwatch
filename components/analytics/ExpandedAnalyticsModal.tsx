          ...
          >
            <div className="h-full w-full bg-[#0a0a0f]/90 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl pointer-events-auto overflow-hidden flex flex-col">
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/10">
                <div>
                  <h2 className="text-2xl font-bold text-white/90">Network Analytics</h2>
                  <p className="text-sm text-white/60 mt-1">Real-time insights into the Xandeum Storage Network</p>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="flex-1 overflow-auto">
                <AnalyticsView nodes={nodes} currentCapacity={currentCapacity} hideHeader={true} />
              </div>
            </div>
          </motion.div>
        </>
